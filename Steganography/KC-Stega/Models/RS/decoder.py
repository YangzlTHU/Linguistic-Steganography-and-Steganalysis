...
def dynamic_decode(decoder,
  ...
  with variable_scope.variable_scope(scope, "decoder") as varscope:
    ...
    def condition(unused_time, unused_outputs_ta, unused_state, unused_inputs,
                  finished, unused_sequence_lengths, unused_bit_num):
      return math_ops.logical_not(math_ops.reduce_all(finished))

    def body(time, outputs_ta, state, inputs, finished, sequence_lengths, bit_num):
      ...
      (next_outputs, decoder_state, next_inputs,
       decoder_finished, hidden_sign) = decoder.step(time, inputs, state, bit_num)
      next_finished = math_ops.logical_or(decoder_finished, finished)
      bit_num = control_flow_ops.cond(hidden_sign, lambda: bit_num , lambda: bit_num + 1)# no_hidden_sign=True即不隐藏信息
      if maximum_iterations is not None:
    ...
    res = control_flow_ops.while_loop(
        ...
        loop_vars=[
            ...
            initial_finished, initial_sequence_lengths, init_bit_num
        ],
  ...
  return final_outputs, final_state, final_sequence_lengths, final_bit_num
