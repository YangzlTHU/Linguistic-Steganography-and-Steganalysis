...
from Models.PHVM_SampleEmbeddingHelper import SampleEmbeddingHelper
...
def dynamic_decode(decoder,
  ...
  with variable_scope.variable_scope(scope, "decoder") as varscope:
    ...
    init_bit_num = constant_op.constant(0, dtype=dtypes.int32)
    # init_interval = init_interval # constant_op.constant([0, 1], dtype=dtypes.int32)
    ...
    def condition(unused_time, unused_outputs_ta, unused_state, unused_inputs,
                  finished, unused_sequence_lengths, unused_bit_num, unused_cur_interval):
      return math_ops.logical_not(math_ops.reduce_all(finished))

    def body(time, outputs_ta, state, inputs, finished, sequence_lengths, bit_num, cur_interval):
      ...
      Args:
        ...
        cur_interval: int32 shape=(2) (AC algorithm divide interval)
    ...
    res = control_flow_ops.while_loop(
        ...
        loop_vars=[
            ...
            initial_finished, initial_sequence_lengths, init_bit_num, init_interval
        ],
  ...
  return final_outputs, final_state, final_sequence_lengths, final_bit_num, final_interval
